...
public class ContainerGenerator extends Container {
    ...
    public ContainerGenerator(InventoryPlayer inventoryPlayer, TileEntityGenerator tileEntityGenerator) {
        ...
        this.addSlotToContainer(new Slot(tileEntityGenerator, 0, 8, 62));
        this.addSlotToContainer(new Slot(tileEntityGenerator, 1, 152, 62));
    ...
    public void addCraftingToCrafters(ICrafting p_75132_1_)
    {
        ...
        p_75132_1_.sendProgressBarUpdate(this, 1, this.tileEntityGenerator.steamAmount);
    }
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.crafters.size(); ++i)
        {
            ...
            if (this.lastSteamAmount != this.tileEntityGenerator.steamAmount)
            {
                icrafting.sendProgressBarUpdate(this, 1, this.tileEntityGenerator.steamAmount);
            }
        }

        this.lastEnergyAmount = this.tileEntityGenerator.energyAmount;
        this.lastSteamAmount = this.tileEntityGenerator.steamAmount;
    }
    ...
    public void updateProgressBar(int p_75137_1_, int p_75137_2_)
    {
        ...
        if (p_75137_1_ == 1)
        {
            this.tileEntityGenerator.steamAmount = p_75137_2_;
        }
    }
